  ...
  if($variableToCheckLoggedIn == false) //1 if condition check if cookies tampered with
    ...
    //initialize the variables
     $answerStatistic="--";$trialsLeft=$points=$error=$nextButton="";
        ...
        $nextquestionDetail = 'NoTheMo22';
        $solution = $section2question1Answer;
        $solution1 = $section2question1Answer1;
   ...
   <body onload="countdown(year,month,day,hour,minute)" style="background-image:url('../images/questionbackground.jpg');background-repeat: no-repeat;  background-size: cover;    background-attachment: fixed;">
     ...
     <div class="container">
       ...
       <div class="row">
         ...
         <h3 id="questionname" style="margin-bottom:50px; ">Who in who? (Rather narcissistic, I must say)</h3>
         <div class="container">
           <div class="row">
             <div class="col-sm-2"></div>
             <div class="image" style="margin-top:-40px; ">
              <a href="../images/D2YoSeFa211.jpg" target="_blank"><img src="../images/D2YoSeFa211.jpg" alt="/" style="width:300px;height:300px;"/></a>
               </div>
           </div>
         </div>
