  ...
  if($variableToCheckLoggedIn == false) //1 if condition check if cookies tampered with
    ...
    //initialize the variables
     $answerStatistic="--";$trialsLeft=$points=$error=$nextButton="";
         $questionDetail = 'section2question2';
        $nextquestionDetail = 'Ta23';
        $solution = $section2question2Answer;
        $solution1 = $section2question2Answer1;
   ...
   <body onload="countdown(year,month,day,hour,minute)" style="background-image:url('../images/questionbackground.jpg');background-repeat: no-repeat;  background-size: cover;    background-attachment: fixed;">
     ...
     <div class="container">
       ...
       <div class="row">
         ...
         <h3 id="questionname" style="margin-bottom:50px; ">Name when there was no warning and no escape. </h3>
         <div class="container">
           <div class="row">
             <div class="col-sm-2"></div>
             <div class="image" style="margin-top:-40px; ">
               <a href="../images/D2NoTheMo221.jpg" target="_blank"><img src="../images/D2NoTheMo221.jpg" alt="/" style="width:300px;height:330px;"/></a>
             </div>
           </div>
         </div>
